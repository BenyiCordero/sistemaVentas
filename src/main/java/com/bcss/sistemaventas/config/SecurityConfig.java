    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        http
                ...
                .cors(httpSecurityCorsConfigurer -> httpSecurityCorsConfigurer.configurationSource(request -> {
                    ...
                    configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:5500", "http://79.143.89.40", "https://smarttech.icu",
                            "https://www.smarttech.icu"));
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/credito-pagos/**").hasAnyRole("ADMIN")
                                ...
                                .requestMatchers("/api/sell/**").hasAnyRole("ADMIN")
                                .requestMatchers("/api/sellDetails/**").hasAnyRole("ADMIN")
